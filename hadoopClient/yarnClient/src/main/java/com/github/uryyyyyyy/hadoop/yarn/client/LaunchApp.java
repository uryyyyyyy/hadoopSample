...
public class LaunchApp {
	...
	public static void main(String[] args) throws IOException, YarnException {
		...
		ApplicationId id = launchApp(client, hdfsUrl + appMasterJarPath, hdfsUrl + containerJarPath, appMasterMainClass, containerMainClass, containerArgs);

		System.out.println(ConverterUtils.toString(id));
	}

	private static ApplicationId launchApp(YarnClient client, String appMasterJarPath, String containerJarPath, String appMasterMainClass, String containerMainClass, String[] containerArgs) throws IOException, YarnException {
